...
import { Monitor, Cpu, Box, Connection, Upload, Bell, Document, Operation, ChatDotRound, Fold, Expand, SwitchButton } from '@element-plus/icons-vue'
...
const menuGroups = [
  ...
  { label:'设备接入', items:['devices','products','protocols','integration'] },
  ...
  <div v-if="!authenticated" class="login-page">
    ...
    <section class="login-panel">
      <el-form :model="loginForm" label-position="top" @submit.prevent="login">
        ...
        <el-button native-type="submit" type="primary" size="large" :loading="loginLoading">进入平台</el-button>
      </el-form>
    </section>
  </div>
